...
import { CookieTokenManager } from './tokenManager'
...
export default class Api {
   ...
   * @param {string} [config.cookieName ='appcookie'] token cookie name
  ...
  constructor(baseURL, config = {}) {
    ...
    if (!this.tokenManager) {
      this.tokenManager = new CookieTokenManager()
  ...
  _initApi() {
    ...
    // NOTE: default has authorization transform
    // request transform
